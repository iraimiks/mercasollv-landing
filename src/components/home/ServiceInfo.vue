        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid md:grid-cols-3 gap-8">
                ...
                <div
                    ...
                    <div class="h-48 bg-gradient-to-r from-orange-600 to-orange-800 relative overflow-hidden">
                        <div
...
Rūsas bojājumi automašīnām bieži sākas aiz plastmasas pārsegiem un paliek nepamanīti, līdz ir par vēlu.
                        ...
                        <ul class="space-y-2">
                            ...
                            <li class="flex items-center">
                                ...
                                <span class="text-sm">Novēršana pēc bojājuma ir daudz dārgāka nekā profilakse.</span>
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div
                    class="bg-gray-800 rounded-xl overflow-hidden shadow-xl transform hover:-translate-y-2 transition duration-300">
                    <div class="h-48 bg-gradient-to-r from-green-600 to-green-800 relative overflow-hidden">
                        <div
